                ...
                <form action="#">
                    <div class="p-4 text-gray-900 dark:text-gray-100 uppercase">
                        ...
                        <div class="flex items-center justify-between py-12 px-16">
                                            ...
                                            @foreach ($match->teamLocal->templates as $template)
                                                <tr>
                                                    ...
                                                    <td class="border border-gray-200 px-2 py-2">
                                                        <input type="text" class="w-10 border text-black border-gray-300 rounded px-2 py-1" onkeypress='return validaNumericos(event)' placeholder="0" />
                                                    </td>
                                                    <td class="border border-gray-200 px-2 py-2">
                                                        <input type="text" class="w-10 border text-black border-gray-300 rounded px-2 py-1" onkeypress='return validaNumericos(event)' placeholder="0" />
                                                    </td>
                            ...
                            <div class="mb-16 ">
                                <input type="text" class="rounded-lg text-xl w-12 h-12 bg-gray-900 text-white text-center mb-16" onkeypress='return validaNumericos(event)'>
                            </div>
                            ...
                            <div class="mb-16">
                                <input type="text" class="rounded-lg w-12 h-12 text-xl bg-gray-900 text-white text-center mb-16"  onkeypress='return validaNumericos(event)'>
                            </div>
                            <div class="flex flex-col items-center">
