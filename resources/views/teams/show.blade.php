...
<x-app-layout>
    <x-slot name="header">
        ...
        <div class="mb-4 p-0">
            <a href="{{ route('teams.index') }}" class="bg-blue-500 hover:bg-blue-700 active:bg-green-400 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline absolute top-12 right-2 mr-5 mt-44"> Template </a>
        </div>
    </x-slot>
    <div class="py-12">
