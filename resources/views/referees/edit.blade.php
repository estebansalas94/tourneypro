                    ...
                    <form action="{{ route('referees.update', $referee->id) }}" method="POST" enctype="multipart/form-data" class="bg-white dark:bg-gray-800 px-8 pt-6 pb-8 mb-4">
                        ...
                        <div class="flex flex-wrap">
                            <div class="w-full md:w-1/2 px-3">
                                ...
                                <input name="name" value="{{ old('name', $referee->name) }}" class="block uppercase tracking-wide appearance-none w-full shadow border rounded py-2 px-3 text-gray-700 dark:text-white bg-gray-900 leading-tight focus:outline-none focus:shadow-outline" id="nya" type="text" placeholder="" required>
                            </div>

                            <div class="w-full md:w-1/2 px-3">
                                <label class="text-gray-700 dark:text-gray-300 text-sm font-bold mb-2 mt-4" for="cn"> Last Name </label>
                                <input name="last_name" value="{{ old('last_name', $referee->last_name) }}" class="block uppercase tracking-wide appearance-none w-full shadow border rounded py-2 px-3 text-gray-700 dark:text-white bg-gray-900 leading-tight focus:outline-none focus:shadow-outline" id="cn" type="text" placeholder="" required>
                            </div>
                            ...
                            <div class="w-full md:w-1/2 px-3">
                                ...
                                <select name="referee_type" class="block uppercase tracking-wide appearance-none w-full shadow border rounded py-2 px-3 text-gray-700 dark:text-white bg-gray-900 leading-tight focus:outline-none focus:shadow-outline" required>
                                    <option value="">{{ old('referee_type', $referee->referee_type) }}</option>
                            ...
                            <div class="w-full md:w-1/2 px-3">
                                ...
                                <input name="nationality" value="{{ old('nationality', $referee->nationality) }}" class="block uppercase tracking-wide shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:text-white bg-gray-900  leading-tight focus:outline-none focus:shadow-outline" id="dor" type="text" placeholder="" required>
                            </div>
